...
function App() {
  useEffect(() => {
    document.title = "Samuel Ainsworth ⚡";
  }, []);
    ...
    >
      <Row className="justify-content-md-center">
        <Col>
          ...
          <p>
            I'm a hacker at heart, moonlighting as a PhD candidate in the School
          ...
          <p>
            Before joining UW I spent four wonderful years at Brown University,
            followed by a stint in Silicon Valley working on self-driving cars
          ...
          <Container style={{ paddingLeft: 0, paddingRight: 0 }}>
            <Row style={{ marginBottom: "10px" }}>
              ...
              <Col xs={9} style={{ backgroundColor: "white" }}>
                ...
                <small style={{ fontSize: "0.75rem" }}>
                  <b>S. Ainsworth</b>, K. Lowrey, J. Thickstun, Z. Harchaoui, S.
                  Srinivasa
                </small>
            ...
            <Row style={{ marginBottom: "10px" }}>
              ...
              <Col xs={9} style={{ backgroundColor: "white" }}>
                <p style={{ fontSize: "0.875rem", marginBottom: 0 }}>
                  Disentangled VAE Representations for Multi-Aspect and Missing
                  Data
                </p>
                <small style={{ fontSize: "0.75rem" }}>
          ...
          <ul>
            ...
            <li>
              ...
              <a href="https://www.cl.cam.ac.uk/~nk480/bidir.pdf">this paper</a>
              , and includes a pedagogically-minded design and readme for others
              getting started with bidirectional typing.
            </li>
            <li>
            ...
            <li>
              ...
              transmits data between phones using only audio. The magic lies in
              error correction.
            </li>
          </ul>
          <p>
            And many more on <a href="https://github.com/samuela">my GitHub</a>
            ...
          </p>
        </Col>
      </Row>
